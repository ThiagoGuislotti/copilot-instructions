...
# Resolves repository root from parameter, git root, or current path.
...
try {
    ...
    $dotnetAuditScript = Resolve-PathFromRoot -RootPath $resolvedRepoRoot -PathValue 'scripts/security/Invoke-VulnerabilityAudit.ps1'
    $frontendAuditScript = Resolve-PathFromRoot -RootPath $resolvedRepoRoot -PathValue 'scripts/security/Invoke-FrontendPackageVulnerabilityAudit.ps1'
    $rustAuditScript = Resolve-PathFromRoot -RootPath $resolvedRepoRoot -PathValue 'scripts/security/Invoke-RustPackageVulnerabilityAudit.ps1'
