...
.EXAMPLE
    pwsh -File scripts/orchestration/stages/implement-stage.ps1 -RepoRoot . -RunDirectory .temp/runs/run-123 -TraceId run-123 -StageId implement -AgentId executor -RequestPath .temp/runs/run-123/artifacts/request.md -InputArtifactManifestPath .temp/runs/run-123/stages/plan-input.json -OutputArtifactManifestPath .temp/runs/run-123/stages/implement-output.json
