...
This folder stores the authoritative Codex skill definitions aligned with `.github/instructions`.
The rendered runtime surface lives under `.codex/skills/`, and it is refreshed through
`scripts/runtime/render-provider-skill-surfaces.ps1` before bootstrap/runtime sync consumes it.
